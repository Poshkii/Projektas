...
public class Platform : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        extraLife = transform.GetChild(2).gameObject;
        extraJump = transform.GetChild(3).gameObject;
        doubleCoins = transform.GetChild(4).gameObject;
        slowTime = transform.GetChild(5).gameObject;
